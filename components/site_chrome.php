...
function render_head_open(array $page): void {
    $s = _chrome_settings();
    $title = $page['title'] ?? 'Alexis Bello — PROINCA · INGCON';
    ...
    <nav class="nav is-scrolled" id="siteNav">
      <div class="nav__inner">
        ...
        <div class="nav__cta-wrap">
          ...
          <a href="/ingcon.php"  class="nav__brand-link nav__brand-link--ingcon  <?= $active === 'ingcon'  ? 'is-active' : '' ?>">INGCON</a>
...
function demo_projects(): array {
    return [
        ...
        ['id' => 'PRJ.002', 'brand' => 'INGCON',  'title' => 'Galpón Industrial Freire', 'type' => 'Industrial · Acero', 'area' => '600 m²', 'year' => 2024, 'city' => 'Freire', 'img' => 'https://images.unsplash.com/photo-1581094794329-c8112a89af12?w=1400&q=85&auto=format&fit=crop', 'text' => 'Estructura metálica para galpón industrial. Diseño sismorresistente bajo NCh 2369. Memoria de cálculo y planos firmados.'],
